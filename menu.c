...
void menu(SDL_Surface *ecran,Mix_Music *musique)
{
    ...
    background = IMG_Load("m3.jpg");
    positionbackground.x = 0;
    positionbackground.y = 0;

    playy=IMG_Load("NG.png");
    positionplay.x=49;
    positionplay.y=315;

    settingg=IMG_Load("OPTION.png");
    positionsetting.x=770-50;
    positionsetting.y=315;

    quit=IMG_Load("EXII.png");
    positionquit.x=470-75;
    positionquit.y=400;
        ...
        switch(event.type)
        {
		   ...
		   case SDLK_LEFT :
			if(x==1)
				...
				{
					playy=IMG_Load("NEW GAME.png");
					quit=IMG_Load("EXI.png");
...
{//void
    ...
    resoluton=IMG_Load("RSS.png");
    positionresoluton.x = 0;
    positionresoluton.y = 310;

    sound=IMG_Load("SOO.png");
    positionsound.x = 850-50;
    positionsound.y = 310;

    control=IMG_Load("IPP.png");
    positioncontrols.x = 430-50+25;
    positioncontrols.y = 310;



    back=IMG_Load("RTNNN.png");
    positionback.x = 20;
    positionback.y = 25;
